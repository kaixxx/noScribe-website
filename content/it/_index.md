...
Questo è il sito ufficiale del software open source noScribe ([GitHub](https://github.com/kaixxx/noScribe)). noScribe è un'app desktop per trascrivere interviste e altri dati audio sensibili – rispettosa della privacy, senza cloud, con modelli di IA locali di alta qualità.
