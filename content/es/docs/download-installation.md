...
- noScribe necesita al menos macOS 14 (Sonoma).
- Descarga:
...
# Asegurate de que Git LFS (Large File Support) este instalado. Es necesario para descargar los modelos desde Hugging Face.
# Debian/Ubuntu:
