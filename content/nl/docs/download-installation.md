...
- noScribe heeft minimaal macOS 14 (Sonoma) nodig.
- Download:
...
# Zorg ervoor dat Git LFS (Large File Support) is geinstalleerd. Dit is nodig om de modellen van Hugging Face te downloaden.
# Debian/Ubuntu:
