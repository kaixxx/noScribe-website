...
- noScribe nécessite au minimum macOS 14 (Sonoma).
- Téléchargement :
...
# Assurez-vous que Git LFS (Large File Support) est installe. Il est necessaire pour telecharger les modeles depuis Hugging Face.
# Debian/Ubuntu:
